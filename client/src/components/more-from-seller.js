  ...
  render() {
          ...
          <div className='single-list-item-key' key={listItem._id}>
            <Link className='more-seller-link' to={`/listings/${listItem._id}`} onClick={this.handleClick}>
             <div className='wrapper-ribbon'>
              <img className='more-seller-thumbnail' src={`http://res.cloudinary.com/letitmow/image/upload/w_200,h_200/${listItem.images[0]}.jpg`} alt={listItem.title}/>
    ...
    return (
      <div className="all-listings-from-user">
        <img className='profile-pic-single' src={this.props.userId.profilePic} alt="Renter Profile Picture"/>
